      ...
      child: Column(children: <Widget>[
        buildLabeledBox(
            ...
            child: Column(children: <Widget>[
              ...
              buildSkillRow(nameSkill: 'ATHLETICS', ability: 'STR', armor: '0'),
              buildSkillRow(
                nameSkill: 'CRAFTING',
                ability: 'INT',
              ),
              ...
              buildSkillRow(nameSkill: 'STEALTH', ability: 'DEX', armor: '0'),
              buildSkillRow(
                nameSkill: 'SURVIVAL',
                ability: 'WIS',
              ),
              buildSkillRow(nameSkill: 'THIEVERY', ability: 'DEX', armor: '0'),
            ])),
        buildLabeledBox(
            label: 'Languages',
            width: 290.0,
            ...
            border: BoxBorder(
                ...
                width: 1.0,
                color: PdfColors.black),
            child: buildNumberBox(number: 'Test')),
      ]));
}
